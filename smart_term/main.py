...
def main() -> int:
    ...
    try:
        ...
        if not args:
            ...
            print("\nUsage: ai [file_path] <query> [--s|--p|--r|--deep] [--show-sources]")
            print("\nModel flags:")
            ...
            print("\nOptions:")
            print("  --show-sources   Display source citations with clickable links")
            print("\nExamples:")
            ...
            print("  ai 'Research query' --deep --show-sources")
            print("\nSpecial commands:")
